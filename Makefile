...
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 5? 23 22:29:49 2014
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/AOSC-VersionHelper1.0.0/ && $(COPY_FILE) --parents qmlapplicationviewer/qmlapplicationviewer.h i18n.h .tmp/AOSC-VersionHelper1.0.0/ && $(COPY_FILE) --parents resources.qrc .tmp/AOSC-VersionHelper1.0.0/ && $(COPY_FILE) --parents main.cpp i18n.cpp qmlapplicationviewer/qmlapplicationviewer.cpp .tmp/AOSC-VersionHelper1.0.0/ && $(COPY_FILE) --parents translations/*.ts .tmp/AOSC-VersionHelper1.0.0/ && (cd `dirname .tmp/AOSC-VersionHelper1.0.0` && $(TAR) AOSC-VersionHelper1.0.0.tar AOSC-VersionHelper1.0.0 && $(COMPRESS) AOSC-VersionHelper1.0.0.tar) && $(MOVE) `dirname .tmp/AOSC-VersionHelper1.0.0`/AOSC-VersionHelper1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/AOSC-VersionHelper1.0.0
...
main.o: main.cpp i18n.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

i18n.o: i18n.cpp i18n.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o i18n.o i18n.cpp
...
install_itemfolder_01: first FORCE
	...
	-$(INSTALL_DIR) /home/anthon/AOSC-VersionHelper/qml/AOSC-VersionHelper $(INSTALL_ROOT)/opt/AOSC-VersionHelper/qml/
