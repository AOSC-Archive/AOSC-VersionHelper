...
# Generated by qmake (2.01a) (Qt 4.8.5) on: ?? 4? 25 18:17:59 2014
# Project:  AOSC-VersionHelper.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile AOSC-VersionHelper.pro
#############################################################################
...
install_itemfolder_01: first FORCE
	@$(CHK_DIR_EXISTS) $(INSTALL_ROOT)/usr//qml/ || $(MKDIR) $(INSTALL_ROOT)/usr//qml/ 
	-$(INSTALL_DIR) /home/anthon/AOSC-VersionHelper/qml/AOSC-VersionHelper $(INSTALL_ROOT)/usr//qml/


uninstall_itemfolder_01:  FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr//qml/AOSC-VersionHelper
	-$(DEL_DIR) $(INSTALL_ROOT)/usr//qml/ 
